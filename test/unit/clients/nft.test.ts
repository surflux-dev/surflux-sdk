...
describe('SurfluxNFTClient', () => {
  ...
  //     const mockResponse: NftsResponseDto = {
  //       items: [
  //         {
  //           object_id: '0x123',
  //           object_type: '0x456::module::NFT',
  ...
  //     const params: GetNFTsForOwnerParams = {
  //       address: '0xdef',
  ...
  //     const result = await client.getNFTsForOwner(params);
  ...
  //     await client.getNFTsForOwner(params);
  ...
  //     await expect(client.getNFTsForOwner(params)).rejects.toThrow(errorMessage);
  //   });
  // });
  ...
  //     const params: GetNFTsForCollectionParams = {
  //       type: collectionType,
  ...
  //     const result = await client.getNFTsForCollection(params);
  ...
  //     await client.getNFTsForCollection(params);
  ...
  //     await expect(client.getNFTsForCollection(params)).rejects.toThrow(errorMessage);
  //   });
  // });
  ...
  //     const mockResponse: CollectionHoldersDto = {
  //       holders: [
  ...
  describe('Input Validation', () => {
    ...
    //     await expect(
    //       client.getNFTsForOwner({ address: '0x123' })
    //     ).resolves.toBeDefined();
    //     await expect(
    //       client.getNFTsForOwner({ address: '0xabcdef123456' })
    //     ).resolves.toBeDefined();
    //     await expect(
    //       client.getNFTsForOwner({ address: '0xABCDEF123456' })
    //     ).resolves.toBeDefined();
    ...
    //     await expect(
    //       client.getNFTsForOwner({ address: undefined as unknown as string })
    //     ).rejects.toThrow('Address is required and must be a non-empty string.');
    //   });

    //   it('should throw error for empty string', async () => {
    //     await expect(client.getNFTsForOwner({ address: '' })).rejects.toThrow(
    //       'Address is required and must be a non-empty string.'
    //     );
    //   });

    //   it('should throw error for address without 0x prefix', async () => {
    //     await expect(client.getNFTsForOwner({ address: '123' })).rejects.toThrow(
    //       'Invalid address format: "123". Address must start with "0x".'
    //     );
    //   });

    //   it('should throw error for invalid hex characters', async () => {
    //     await expect(client.getNFTsForOwner({ address: '0x123g' })).rejects.toThrow(
    ...
    //     await expect(
    //       client.getNFTsForCollection({ type: '0x123::module::NFT' })
    //     ).resolves.toBeDefined();
    //     await expect(
    //       client.getNFTsForCollection({ type: '0xabcdef::my_module::MyNFT' })
    //     ).resolves.toBeDefined();
    //     await expect(
    //       client.getNFTsForCollection({ type: '0x123::module_name::TypeName' })
    //     ).resolves.toBeDefined();
    //   });

    //   it('should throw error for undefined type', async () => {
    //     await expect(
    //       client.getNFTsForCollection({ type: undefined as unknown as string })
    //     ).rejects.toThrow('Type is required and must be a non-empty string.');
    //   });

    //   it('should throw error for empty string', async () => {
    //     await expect(client.getNFTsForCollection({ type: '' })).rejects.toThrow(
    //       'Type is required and must be a non-empty string.'
    //     );
    //   });

    //   it('should throw error for type without :: separators', async () => {
    //     await expect(client.getNFTsForCollection({ type: '0x123' })).rejects.toThrow(
    ...
    //     await expect(
    //       client.getNFTsForCollection({ type: '0x123::module' })
    //     ).rejects.toThrow(
    //       'Invalid type format: "0x123::module". Type must follow the pattern "address::module::Type" (e.g., "0x123::module::NFT").'
    //     );
    //     await expect(
    //       client.getNFTsForCollection({ type: '0x123::module::Type::Extra' })
    //     ).rejects.toThrow();
    //   });

    //   it('should throw error for invalid address part', async () => {
    //     await expect(
    //       client.getNFTsForCollection({ type: '123::module::NFT' })
    //     ).rejects.toThrow('Invalid type format: "123::module::NFT". Address part must start with "0x".');
    //     await expect(
    //       client.getNFTsForCollection({ type: '0x::module::NFT' })
    //     ).rejects.toThrow();
    //     await expect(
    //       client.getNFTsForCollection({ type: '0xg::module::NFT' })
    //     ).rejects.toThrow();
    //   });

    //   it('should throw error for invalid module name', async () => {
    //     await expect(
    //       client.getNFTsForCollection({ type: '0x123::123module::NFT' })
    //     ).rejects.toThrow(
    ...
    //     );
    //     await expect(
    //       client.getNFTsForCollection({ type: '0x123::module-name::NFT' })
    //     ).rejects.toThrow();
    //   });
    ...
    //     );
    //     await expect(
    //       client.getNFTsForCollection({ type: '0x123::module::123NFT' })
    //     ).rejects.toThrow();
    //   });
    // });
    ...
    //     await expect(
    //       client.getNFTsForOwner({ address: '0x123', page: 1 })
    //     ).resolves.toBeDefined();
    //     await expect(
    //       client.getNFTsForOwner({ address: '0x123', page: 10 })
    //     ).resolves.toBeDefined();
    //     await expect(
    //       client.getNFTsForOwner({ address: '0x123', page: undefined })
    //     ).resolves.toBeDefined();
    //   });

    //   it('should throw error for page below minimum', async () => {
    //     await expect(
    //       client.getNFTsForOwner({ address: '0x123', page: 0 })
    ...
    //     await expect(
    //       client.getNFTsForOwner({ address: '0x123', page: 1.5 })
    //     ).rejects.toThrow('Page must be an integer, got: 1.5.');
    //   });

    //   it('should throw error for non-number page', async () => {
    //     await expect(
    //       client.getNFTsForOwner({ address: '0x123', page: '1' as unknown as number })
    ...
    //     await expect(
    //       client.getNFTsForOwner({ address: '0x123', per_page: 1 })
    //     ).resolves.toBeDefined();
    //     await expect(
    //       client.getNFTsForOwner({ address: '0x123', per_page: 100 })
    //     ).resolves.toBeDefined();
    //     await expect(
    //       client.getNFTsForOwner({ address: '0x123', per_page: 1000 })
    //     ).resolves.toBeDefined();
    //     await expect(
    //       client.getNFTsForOwner({ address: '0x123', per_page: undefined })
    //     ).resolves.toBeDefined();
    //   });

    //   it('should throw error for per_page below minimum', async () => {
    //     await expect(
    //       client.getNFTsForOwner({ address: '0x123', per_page: 0 })
